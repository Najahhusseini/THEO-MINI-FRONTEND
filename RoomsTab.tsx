...
import {
  ...
  checkInStay,
  moveStayToRoom,      // ✨ NEW
  setRoomOutOfOrder    // already imported, but ensure it's here
} from '@/lib/api'
...
export default function RoomsTab() {
    ...
    // … existing handlers unchanged (handleStatusChange, handleSetOutOfOrder, etc.) …
    ...
    return (
        <div className="min-h-screen bg-gray-50 p-6">
                ...
                <div className="fixed inset-0 bg-black/60 flex items-center justify-center z-50 p-4">
                    <div className="bg-white rounded-2xl max-w-md w-full shadow-2xl overflow-hidden">
                        ...
                        <div className="p-6 space-y-4">
                            ...
                            {/* ✨ REASSIGN GUEST BUTTON (visible for occupied / arriving today rooms) */}
            ...
            {/* REASSIGN CLEANER MODAL (unchanged) */}
                ...
                <div className="fixed inset-0 bg-black/60 flex items-center justify-center z-50 p-4">
                    <div className="bg-white rounded-2xl max-w-lg w-full shadow-2xl overflow-hidden">
                        ...
                        <div className="p-6 space-y-4">
                            ...
                            {/* Mark current room out of order */}
